...
<div class="daily-column">
        <h4 style="text-align: center; color: white;"><?php echo $EM_time_duration; ?></h4>
...
<!-- Late evening column -->
<div class="daily-column">
        <h4 style="text-align: center; color: #fff;"><?php echo $LE_time_duration; ?></h4>
        <div class=" col-padding margin-style"  style=" height: 100%; min-height: 200px;" >
 ...
 <?php   }else{
   ...
   // $dataz['sub'] = $sub;
    ...
    if($lang=='English'){
        ...
        $sqlz = "SELECT season,description,impact,graph,audio,issuetime FROM  seasonal_forecast WHERE region = '$region' AND subregionid = '$subregion' AND description IS NOT NULL order by issuetime DESC limit 1 ";
